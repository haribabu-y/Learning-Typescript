...
function flipElement(element) {
    ...
    let frontCard = element.querySelector('.card-front');
    console.log(frontCard);
    let backCard = element.querySelector(".card-back");
    ...
    if (flippeditems.length == 2) {
        ...
        setTimeout(() => {
            ...
            if (score == 1) {
                ...
                flippedElements.forEach(element => {
                    let elementfc = element.querySelector('.card-front');
                    let elementbc = element.querySelector('.card-back');
            ...
            let displayflipes = document.getElementById('flipcount');
